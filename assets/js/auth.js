            ...
            if (isValid) {
                ...
                .then(data => {
                    ...
                    if (data.success === true || data.status === 'success') {
                        ...
                        // Show error
                        showError(loginPasswordError, data.message || 'Invalid email or password.');
                    }
                })
                .catch(error => {
                    // Re-enable submit button
                    ...
                    if (data.success) {
                        ...
                        document.getElementById('forgotPasswordForm').innerHTML = `
                            <div class="success-message">
                                ...
                                <p>We've sent a password reset link to ${resetEmail}. Please check your inbox.</p>
                                ${data.test_reset_link ? `<p class="test-info">For testing: <a href="${data.test_reset_link}" target="_blank">Reset Link</a></p>` : ''}
                            </div>
                            <button type="button" class="btn btn-primary btn-large btn-block" id="backToLoginBtn">
                                Back to Login
                            </button>
                        `;
                        ...
                        // Show error
                        resetEmailError.textContent = data.message || 'Failed to send reset link. Please try again.';
                    }
                })
                .catch(error => {
                    // Re-enable submit button
